...
class Plaxis2DInputController:
    ...
    def get_material_parameter_value(self, material: PlxProxyObject, parameter_name: str) -> float:
    ...
    def set_material_parameter_value(self, material: PlxProxyObject, parameter_name: str, value: float) -> None:
